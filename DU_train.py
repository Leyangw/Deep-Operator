...
def main():
    ...
    train_MyModel(1,1,16,4,0,device).train(Dataloader=train_data,epochs=10,
                                    ckp_interval= 10,step_size=0.4,model = 'DU',lr_rate1=0.01,lr_rate2=0.0001,
                                    train_data=train_data,batch_size=batch_size,save_path='C:/Users/w1642/Desktop',test_data=test_data)
